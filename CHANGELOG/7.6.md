...
<li>[release/v7.6.1] Update branch for release (#27287)</li>
<li>[release/v7.6.1] Fix package pipeline by adding in PDP-Media directory (#27257)</li>
<li>[release/v7.6.1] Pin ready-to-merge.yml reusable workflow to commit SHA (#27245)</li>
<li>[release/v7.6.1] [StepSecurity] ci: Harden GitHub Actions tags (#27236)</li>
<li>[release/v7.6.1] Build, package, and create VPack for the PowerShell-LTS store package within the same <code>msixbundle-vpack</code> pipeline (#27237)</li>
<li>[release/v7.6.1] Change the display name of PowerShell-LTS package to PowerShell LTS (#27219)</li>
<li>[release/v7.6.1] [StepSecurity] ci: Harden GitHub Actions tokens (#27218)</li>
<li>[release/v7.6.1] Redo windows image fix to use latest image (#27217)</li>
<li>[release/v7.6.1] Add comment-based help documentation to build.psm1 functions (#27216)</li>
<li>[release/v7.6.1] Separate Store Package Creation, Skip Polling for Store Publish, Clean up PDP-Media (#27214)</li>
<li>[release/v7.6.1] Bump github/codeql-action from 4.34.1 to 4.35.1 (#27184)</li>
<li>[release/v7.6.1] Bump github/codeql-action from 4.32.6 to 4.34.1 (#27182)</li>
<li>[release/v7.6.1] Select New MSIX Package Name (#27183)</li>
<li>[release/v7.6.1] Update the PhoneProductId to be the official LTS id used by Store (#27181)</li>
<li>[release/v7.6.1] release-upload-buildinfo: replace version-comparison channel gating with metadata flags (#27180)</li>
<li>[release/v7.6.1] Move <code>_GetDependencies</code> MSBuild target from dynamic generation in <code>build.psm1</code> into <code>Microsoft.PowerShell.SDK.csproj</code> (#27177)</li>
<li>[release/v7.6.1] Separate Official and NonOfficial templates for ADO pipelines (#27176)</li>
</ul>
