...
<p>Update to .NET SDK 8.0.425</p>

</summary>

<ul>
<li>Use Custom Validation Policy for vPack Pipeline (#27913)</li>
<li>Fix installing .NET for non-Early-Access releases (#27926)</li>
<li>Fix OneBranch output variables for early-access .NET jobs (#27920)</li>
<li>Use early-access .NET SDK and NuGet feed for build, package, and release pipelines (#27910)</li>
</ul>

</details>

[7.4.20]: https://github.com/PowerShell/PowerShell/compare/v7.4.19...v7.4.20
