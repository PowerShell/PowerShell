...
<li>Fix OneBranch output variables for early .NET jobs (#27920)</li>
<li>Use .NET SDK and NuGet feed early access for build, package and release pipelines (#27910)</li>
</ul>
