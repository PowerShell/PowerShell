...
- Do not run labels workflow in the internal repo (#25411)
...
<li> Revert &quot;Cleanup old release pipelines (#25201)&quot; (#25408)</li>
<li> Switch to ubuntu-lastest for CI (#25406)</li>
<li> Update GitHub Actions to work in private GitHub repo (#25403)</li>
