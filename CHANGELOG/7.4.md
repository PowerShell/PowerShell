...
<ul>
<li>[release/v7.4] Update branch for release (#25101)</li>
<li>[release/v7.4] Only build Linux for packaging changes (#25161)</li>
<li>[release/v7.4] Skip additional packages when generating component manifest (#25160)</li>
<li>[release/v7.4] Remove Az module installs and AzureRM uninstalls in pipeline (#25157)</li>
<li>[release/v7.4] Add GitHub Actions workflow to verify PR labels (#25158)</li>
<li>[release/v7.4] Update security extensions (#25099)</li>
<li>[release/v7.4] Make Component Manifest Updater use neutral target in addition to RID target (#25100)</li>
</ul>
