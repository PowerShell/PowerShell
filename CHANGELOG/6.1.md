...
- Add xUnit project to `PowerShell.slnx` and make it runnable from within VisualStudio (#7254) (Thanks @bergmeister!)
...
- Remove PSReadLine from then `PowerShell.slnx` file (#7137)
- Fix the file `PowerShell.slnx` that was corrupted by accident (#7288)
- Fix the encoding of `PowerShell.slnx` to be `utf-8` (#7289)
