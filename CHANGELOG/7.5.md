...
- [release/v7.5.6] Fix the `PSNativeCommandArgumentPassing` test (#27166)
...
<ul>
<li>[release/v7.5.6] Update branch for the v7.5.6 release (#27268)</li>
<li>[release/v7.5.6] Fix package pipeline by adding in <code>PDP-Media</code> directory (#27256)</li>
<li>[release/v7.5.6] Pin <code>ready-to-merge.yml</code> reusable workflow to commit SHA (#27246)</li>
<li>[release/v7.5.6] [StepSecurity] ci: Harden GitHub Actions tags (#27239)</li>
<li>[release/v7.5.6] Build, package, and create VPack for the PowerShell-LTS store package within the same <code>msixbundle-vpack</code> pipeline (#27240)</li>
<li>[release/v7.5.6] Add comment-based help documentation to <code>build.psm1</code> functions (#27221)</li>
<li>[release/v7.5.6] Separate store package creation, skip polling for store publish, clean up <code>PDP-Media</code> (#27225)</li>
<li>[release/v7.5.6] [StepSecurity] ci: Harden GitHub Actions tokens (#27224)</li>
<li>[release/v7.5.6] Change the display name of "PowerShell-LTS" package to "PowerShell LTS" (#27223)</li>
<li>[release/v7.5.6] Redo windows image fix to use latest image (#27222)</li>
<li>[release/v7.5.6] Bump <code>github/codeql-action</code> from 4.32.4 to 4.35.1 (#27159) (#27170) (#27174)</li>
<li>[release/v7.5.6] Select new MSIX package name (#27172)</li>
<li>[release/v7.5.6] Update the <code>PhoneProductId</code> to be the official LTS id used by Store (#27168)</li>
<li>[release/v7.5.6] release-upload-buildinfo: replace version-comparison channel gating with metadata flags (#27167)</li>
<li>[release/v7.5.6] Create infrastructure to create two msixs and msixbundles for LTS and Stable (#27165)</li>
<li>[release/v7.5.6] Move <code>_GetDependencies</code> MSBuild target from dynamic generation in <code>build.psm1</code> into <code>Microsoft.PowerShell.SDK.csproj</code> (#27164)</li>
<li>[release/v7.5.6] Create Linux LTS deb/rpm packages for LTS releases (#27163)</li>
<li>[release/v7.5.6] Fix the container image for vPack, MSIX vPack and Package pipelines (#27161)</li>
<li>[release/v7.5.6] Create LTS pkg and non-LTS pkg for macOS for LTS releases (#27162)</li>
<li>[release/v7.5.6] Bump actions/dependency-review-action from 4.8.3 to 4.9.0 (#27158)</li>
<li>[release/v7.5.6] Bump actions/upload-artifact from 6 to 7 (#27157)</li>
<li>[release/v7.5.6] Separate "Official" and "NonOfficial" templates for ADO pipelines (#27155)</li>
</ul>
