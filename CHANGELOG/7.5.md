...
<ul>
<li>[release/v7.5] Cleanup old release pipelines (#25236)</li>
</ul>
...
- [release/v7.5] Do not run labels workflow in the internal repository (#25343)
- [release/v7.5] Update CODEOWNERS (#25321)
- [release/v7.5] Check GH token availability for Get-Changelog (#25328)
- [release/v7.5] Add Justin Chung as PowerShell team member in `releaseTools.psm1` (#25302)
...
<li>[release/v7.5] Add CodeQL suppressions for PowerShell intended behavior (#25375)</li>
<li>[release/v7.5] Update to .NET SDK 9.0.203 (#25373)</li>
<li>[release/v7.5] Switch to ubuntu-lastest for CI (#25374)</li>
<li>[release/v7.5] Add default .NET install path for SDK validation (#25338)</li>
<li>[release/v7.5] Combine GitHub and Nuget Release Stage (#25371)</li>
<li>[release/v7.5] Add Windows Store Signing to MSIX bundle (#25370)</li>
<li>[release/v7.5] Update test result processing to use NUnitXml format and enhance logging for better clarity (#25344)</li>
<li>[release/v7.5] Fix MSIX stage in release pipeline (#25345)</li>
<li>[release/v7.5] Make GitHub Workflows work in the internal mirror (#25342)</li>
<li>[release/v7.5] Update security extensions (#25322)</li>
<li>[release/v7.5] Disable SBOM generation on set variables job in release build (#25340)</li>
<li>[release/v7.5] Update GitHub Actions to work in private GitHub repo (#25332)</li>
<li>[release/v7.5] Revert &quot;Cleanup old release pipelines (#25201)&quot; (#25335)</li>
<li>[release/v7.5] Remove call to NuGet (#25334)</li>
<li>[release/v7.5] Simplify PR Template (#25333)</li>
<li>[release/v7.5] Update package pipeline windows image version (#25331)</li>
<li>[release/v7.5] Skip additional packages when generating component manifest (#25329)</li>
<li>[release/v7.5] Only build Linux for packaging changes (#25326)</li>
<li>[release/v7.5] Make Component Manifest Updater use neutral target in addition to RID target (#25325)</li>
<li>[release/v7.5] Remove Az module installs and AzureRM uninstalls in pipeline (#25327)</li>
<li>[release/v7.5] Make sure the vPack pipeline does not produce an empty package (#25320)</li>
<li>[release/v7.5] Add *.props and sort path filters for windows CI (#25316)</li>
<li>[release/v7.5] Fix V-Pack download package name (#25314)</li>
<li>[release/v7.5] Update path filters for Windows CI (#25312)</li>
<li>[release/v7.5] Give the pipeline runs meaningful names (#25309)</li>
<li>[release/v7.5] Migrate MacOS Signing to OneBranch (#25304)</li>
<li>[release/v7.5] Add UseDotnet task for installing dotnet (#25281)</li>
<li>[release/v7.5] Remove obsolete template from Windows Packaging CI (#25237)</li>
<li>[release/v7.5] Add setup dotnet action to the build composite action (#25235)</li>
<li>[release/v7.5] Add GitHub Actions workflow to verify PR labels (#25159)</li>
<li>[release/v7.5] Update branch for release  - Transitive - true - minor (#24994)</li>
<li>[release/v7.5] Fix GitHub Action filter overmatching (#24958)</li>
<li>[release/v7.5] Fix release branch filters (#24959)</li>
<li>[release/v7.5] Convert powershell/PowerShell-CI-macos to GitHub Actions (#24954)</li>
<li>[release/v7.5] Convert powershell/PowerShell-CI-linux to GitHub Actions (#24946)</li>
<li>[release/v7.5] Convert powershell/PowerShell-Windows-CI to GitHub Actions (#24931)</li>
<li>[release/v7.5] PMC parse state correctly from update command's response (#24859)</li>
<li>[release/v7.5] Add EV2 support for publishing PowerShell packages to PMC (#24856)</li>
</ul>
