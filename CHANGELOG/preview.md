...
<p>We thank the following contributors!</p>
<p>@step-security-bot, @powercode, @kasperk81, @xtqqczze</p>

</summary>

<ul>
<li>[master] Update branch for release (#27291)</li>
...
<li>Bump actions/checkout from 6.0.0 to 6.0.2 (#27206)</li>
...
<li>[StepSecurity] ci: Harden GitHub Actions (#27201) (Thanks @step-security-bot!)</li>
<li>[StepSecurity] ci: Harden GitHub Actions (#27202) (Thanks @step-security-bot!)</li>
