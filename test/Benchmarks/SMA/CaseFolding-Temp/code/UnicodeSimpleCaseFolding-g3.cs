...
namespace System.Management.Automation.Unicode
{
    /// <summary>
    /// </summary>
    internal static partial class SimpleCaseFoldingG3
    {
            static  ushort refL1 = MemoryMarshal.GetReference(L1.AsSpan());
            static ushort refL2 = MemoryMarshal.GetReference(L2.AsSpan());
            static char refL3 = MemoryMarshal.GetReference(L3.AsSpan());
        ...
        /// </summary>
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string SimpleCaseFold_g3(this string source)
        {
...
*/
    ...
    /// </summary>
    public class StringComparerUsingSimpleCaseFolding_g3 : IComparer, IEqualityComparer, IComparer<string>, IEqualityComparer<string>
    {
        ...
        /// </summary>
        public StringComparerUsingSimpleCaseFolding_g3()
        {
        }
        ...
        public int Compare(object x, object y)
        {
            ...
            {
                return SimpleCaseFoldingG3.CompareUsingSimpleCaseFolding(sa, sb);
            }
        ...
        private static int GetHashCodeSimpleCaseFolding(string source)
        {
            ...
            SimpleCaseFoldingG3.SpanSimpleCaseFold(span, source);
        ...
        public int Compare(string x, string y)
        {
            ...
            return SimpleCaseFoldingG3.CompareUsingSimpleCaseFolding(x, y);
        }
        ...
        public bool Equals(string x, string y)
        {
            ...
            return SimpleCaseFoldingG3.CompareUsingSimpleCaseFolding(x, y) == 0;
        }
