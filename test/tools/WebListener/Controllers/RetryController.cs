...
namespace mvc.Controllers
{
    public class RetryController : Controller
    {
        ...
        public JsonResult Retry(string sessionId, int failureCode, int failureCount, int RetryAfter = null)
        {
        ...
        public JsonResult RetryAfter(string sessionId, int failureCode, int failureCount, string RetryAfter)
        {
            retryInfo ??= new Dictionary<string, Tuple<int, int, int>>();
            Response.Headers.Append("Retry-After", RetryAfter);
