        ...
        It "Tab completion dynamic parameter of a custom function" {
            function Test-DynamicParam {
                ...
                DYNAMICPARAM {
                    ...
                    $deSecond = [System.Management.Automation.RuntimeDefinedParameter]::new('DeSecond', [array], $attributeCollection)
                    $deThird = [System.Management.Automation.RuntimeDefinedParameter]::new('DeThird', [array], $attributeCollection)
