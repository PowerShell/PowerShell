...
'@
    ...
    Context 'get-help -Examples multi-line code block should be handled' {
        ...
        $x = get-help foo
        It '$x.examples.example[0].introduction[0].text' { $x.examples.example[0].introduction[0].text | Should -BeExactly "PS > " }
        It '$x.examples.example[0].code' { $x.examples.example[0].code | Should -BeExactly "`$a = Get-Service" }
        It '$x.examples.example[0].remarks[0].text' { $x.examples.example[0].remarks[0].text | Should -BeExactly '$a | group Status' }
        It '$x.examples.example[0].remarks.length' { $x.examples.example[0].remarks.length | Should -Be 5 }
        It '$x.examples.example[1].introduction[0].text' { $x.examples.example[1].introduction[0].text | Should -BeExactly "PS>" }
        It '$x.examples.example[1].code' { $x.examples.example[1].code | Should -BeExactly "`$a = Get-Service" }
        It '$x.examples.example[1].remarks[0].text' { $x.examples.example[1].remarks[0].text | Should -BeExactly "PS> `$a | group Status`n`nExplanation." }
        It '$x.examples.example[1].remarks.length' { $x.examples.example[1].remarks.length | Should -Be 5 }
        It '$x.examples.example[2].introduction[0].text' { $x.examples.example[2].introduction[0].text | Should -BeExactly "PS>" }
        It '$x.examples.example[2].code' { $x.examples.example[2].code | Should -BeExactly "Get-Service" }
        It '$x.examples.example[2].remarks[0].text' { $x.examples.example[2].remarks[0].text | Should -BeExactly "Output" }
        ...
        It '$x.examples.example[3].code' { $x.examples.example[3].code | Should -BeExactly "Get-Service" }
        It '$x.examples.example[3].remarks[0].text' { $x.examples.example[3].remarks[0].text | Should -BeExactly "Output`n`nExplanation.`nSecond line." }
        ...
        It '$x.examples.example[4].code' { $x.examples.example[4].code | Should -BeExactly "Get-Service" }
        It '$x.examples.example[4].remarks[0].text' { $x.examples.example[4].remarks[0].text | Should -BeExactly "Output`n`nExplanation.`n`nNext section." }
