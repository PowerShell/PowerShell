...
Describe "Windows Installer" -Tags "Scenario" {
    ...
    Context "Universal C Runtime Download Link" {
        $universalCRuntimeDownloadLink = 'https://www.microsoft.com/en-us/download/details.aspx?id=50410'
    ...
    Context "Visual Studio C++ Redistributables Link" {
        $visualStudioCPlusPlusRedistributablesDownloadLink = 'https://www.microsoft.com/en-gb/download/details.aspx?id=48145'
