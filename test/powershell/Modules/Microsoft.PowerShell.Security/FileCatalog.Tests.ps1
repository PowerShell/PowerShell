...
function CompareHashTables
{
    ...
    BeforeAll {
        ...
        $testCaseFolderPath = ".\Security_TestData\CatalogTestData"
        
        # Copy the test files to the remote target
        $remoteSystemDrive = Remotely { $env:SystemDrive }
        $remoteSystemDrive | Should Not Be $null
        
        $remoteTestDirectory = "$remoteSystemDrive\MultiMachineTestData\Commands\"
        ...
        } -ArgumentList $remoteTestDirectory | Out-Null

        $sessions = @(Get-RemoteSession)
        ($sessions.Count -eq 1) | Should be true

        foreach ($session in $sessions)
        {
            Copy-Item -Path $testCaseFolderPath -Destination $remoteTestDirectory -Force -Recurse -ToSession $session -Verbose
        }
     
        $exists = Remotely {
            param ($path)
            Test-Path -Path $path
        } -ArgumentList $remoteTestDirectory 
        $exists | Should be $true

        $remoteTestSubDirectory = "$remoteTestDirectory\CatalogTestData"
    }
        ...
        It "NewFileCatalogFolder" {                    
            ...
            $result = Remotely {
                ...
                {                          
                    ...
                    Test-FileCatalog -Path $sourcePath -CatalogFilePath $catalogPath -Detailed                   
                }
                finally
                {
                   Remove-Item $catalogPath -Force -ErrorAction SilentlyContinue         
                }          
            }  -ArgumentList $remoteTestSubDirectory    
              
            # Validate result properties
            $result.Status | Should Be "Valid"           
            $result.Signature.Status.Value | Should Be "NotSigned" 
        ...
        It "NewFileCatalogFolderWithSubFolders" {                                   
         ...
         It "NewFileCatalogWithSingleFile" {
            ...
            $result = Remotely {
                ...
                {        
                   $null = New-FileCatalog -Path $sourcePath -CatalogFilePath $catalogPath                  
                   Test-FileCatalog -Path $sourcePath -CatalogFilePath ($catalogPath + "\catalog.cat")                 
                }
                finally
                {
         ...
         It "NewFileCatalogForFilesThatDoNotSupportEmbeddedSignatures" {
            ...
            $result = Remotely {
                ...
                {        
                    ...
                    Test-FileCatalog -Path "$testDataPath\TestImage.gif","$testDataPath\TestFileCatalog.txt"  -CatalogFilePath ($catalogPath + "\catalog.cat") -Detailed                                                    
                }
                finally
                {
         ...
         It "NewFileCatalogWithMutipleFoldersAndFiles" {
            ...
            $expectedPathsAndHashes = @{ "UserConfigProv.psd1" = "748E5486814051DA3DFB79FE8964152727213248" ;
            ...
            $result = Remotely {
                ...
                {        
                    ...
                    Test-FileCatalog -Path $catalogDataPath -CatalogFilePath $catalogPath -Detailed                               
                }
                finally
                {
                    Remove-Item "$catalogPath" -Force -ErrorAction SilentlyContinue
          ...
          It "NewFileCatalogVersion2WithMutipleFoldersAndFiles" {
             ...
             $expectedPathsAndHashes = @{ "UserConfigProv.psd1" = "9FFE4CA2873CD91CDC9D71362526446ECACDA64D26DEA768E6CE489B84D888E4" ;
         ...
         It "NewFileCatalogFolderWhenCatlogFileIsCreatedInsideSameFolder" {
              ...
              $result = Remotely {
                ...
                try
                {
                    ...
                    Test-FileCatalog -Path $env:temp\UserConfigProv\ -CatalogFilePath $catalogPath                     
                }
                finally
                {
                    Remove-Item "$catalogPath" -Force -ErrorAction SilentlyContinue
            ...
            It "NewFileCatalogWithUnicodeCharactersInFileNames" {
             ...
             $result = Remotely {
                ...
                $null = New-Item -ItemType File -Path "$testDataPath\ɥ ɦ ɧ ɨ ɩ ɪ ɫ ɬ.txt" -Force -ErrorAction SilentlyContinue                                                                                                                                                      
                $null = Add-Content -Path "$testDataPath\ɥ ɦ ɧ ɨ ɩ ɪ ɫ ɬ.txt" -Value "Testing unicode"                                                                                                                                                
                $null = Out-File -FilePath "$testDataPath\ɥ ɦ ɧ ɨ ɩ ɪ ɫ ɬ.txt" -Encoding unicode -InputObject "ɗ ɘ ə ɚ ɛ ɜ ɝ ɞ ɟ ɠ ɡ ɢ ɣ ɤ ɥ ɦ ɧ ɨ ɩ ɪ ɫ ɬ ɭ ɮ ɯ ɰ ɱ ɲ ɳ ɴ ɵ ɶ ɷ ɸ ɹ ɺ ɻ ɼ ɽ ɾ ɿ ʀ ʁ ʂ ʃ ʄ ʅ" -Append
  
                $null = New-Item -ItemType File -Path "$testDataPath\ٿ ڀ ځ ڂ ڃ ڄ څ چ ڇ ڈ ډ ڊ ڋ ڌ ڍ ڎ ڏ ڐ ڑ.txt" -Force -ErrorAction SilentlyContinue                                                                                                                                                                    
                $null = Out-File -FilePath "$testDataPath\ٿ ڀ ځ ڂ ڃ ڄ څ چ ڇ ڈ ډ ڊ ڋ ڌ ڍ ڎ ڏ ڐ ڑ.txt" -Encoding unicode -InputObject "ਅ ਆ ਇ ਈ ਉ ਊ ਏ ਐ ਓ ਔ ਕ ਖ ਗ ਘ ਙ ਚ ਛ ਜ ਝ ਞ ਟ ਠ ਡ ਢ ਣ ਤ ਥ ਦ ਧ ਨ ਪ ਫ ਬ ਭ ਮ ਯ ਰ ਲ ਲ਼ ਵ " -Append
                $null = Out-File -FilePath "$testDataPath\ٿ ڀ ځ ڂ ڃ ڄ څ چ ڇ ڈ ډ ڊ ڋ ڌ ڍ ڎ ڏ ڐ ڑ.txt" -Encoding unicode -InputObject  "அ ஆ இ ஈ உ ஊ எ ஏ ஐ ஒ ஓ ஔ க ங ச ஜ ஞ ட ண த ந ன ப ம ய ர ற ல ள ழ வ ஷ ஸ ஹ " -Append               

                $catalogPath = "$env:TEMP\క ఖ గ ఘ ఙ చ ఛ జ ఝ ఞ.cat"             
                $catalogDataPath = @("$testDataPath\UserConfigProv\", "$testDataPath\ٿ ڀ ځ ڂ ڃ ڄ څ چ ڇ ڈ ډ ڊ ڋ ڌ ڍ ڎ ڏ ڐ ڑ.txt" ,"$testDataPath\ɥ ɦ ɧ ɨ ɩ ɪ ɫ ɬ.txt")                                       
        ...
        AfterEach {
         ...
         It "TestCatalogWhenNewFileAddedtoFolderBeforeValidation" {
            ...
            $result = Remotely {
                ...
                Test-FileCatalog -Path $env:temp\UserConfigProv -CatalogFilePath $script:catalogPath -Detailed
            ...
            $result = Remotely {
                ...
                Test-FileCatalog -Path $env:temp\UserConfigProv -CatalogFilePath $script:catalogPath -Detailed -FilesToSkip "NewFile.txt"
         ...
         It "TestCatalogWhenNewFileDeletedFromFolderBeforeValidation" {
            ...
            $result = Remotely {
             ...
             $result = Remotely {
                ...
                Test-FileCatalog -Path $env:temp\UserConfigProv -CatalogFilePath $script:catalogPath -Detailed -FilesToSkip "UserConfigProviderModVersion1.psm1"
        ...
        AfterEach {
         ...
         It "TestCatalogSkipSingleFileDuringValidation" {
            ...
            $result = Remotely {
                ...
                $null = New-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -CatalogVersion 2.0                
                Test-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -FilesToSkip "scriptdsc.schema"
         ...
         It "TestCatalogSkipCertainFileTypeDuringValidation" {
            $result = Remotely {
                ...
                $null = New-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -CatalogVersion 2.0                
                Test-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -FilesToSkip "*.mof"
          ...
          It "TestCatalogSkipWildCardPatternDuringValidation" {
           ...
           $result = Remotely {
                ...
                $null = New-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -CatalogVersion 1.0                
                Test-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -FilesToSkip "UserConfigProvider*.psm1"
         ...
         It "TestCatalogSkipMuitplePattensDuringValidation" {
           ...
           $result = Remotely {
                ...
                $null = New-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -CatalogVersion 1.0                
                Test-FileCatalog -Path $testDataPath\UserConfigProv\ -CatalogFilePath $script:catalogPath -FilesToSkip "*.psd1","UserConfigProviderModVersion2.psm1","*ModVersion1.schema.mof"
