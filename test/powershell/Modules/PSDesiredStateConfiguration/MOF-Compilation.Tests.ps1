...
Describe "DSC MOF Compilation" -tags "CI" {
    ...
    BeforeAll {
        $SkipTest = $IsMacOS -or $IsWindows -or ((Get-PlatformInfo) -match "alpine|raspbian")
    ...
    It "Should be able to compile a MOF from a basic configuration" -Skip:${SkipTest} {
        [Scriptblock]::Create(@"
...
"@) | Should -Not -Throw
    ...
    It "Should be able to compile a MOF from another basic configuration" -Skip:${SkipTest} {
        [Scriptblock]::Create(@"
        configuration DSCTestConfig
        {
            Import-DscResource -ModuleName PSDesiredStateConfiguration
...
"@) | Should -Not -Throw
    ...
    It "Should be able to compile a MOF from a complex configuration" -Skip:${SkipTest} {
        [Scriptblock]::Create(@"
...
"@) | Should -Not -Throw
    ...
    It "Should be able to compile a MOF from a basic configuration on Windows" -Skip:${SkipTest} {
        [Scriptblock]::Create(@"
        configuration DSCTestConfig
        {
            Import-DscResource -ModuleName PSDesiredStateConfiguration
...
"@) | Should -Not -Throw
    ...
    It "Should be able to compile a MOF from a configuration with multiple resources on Windows" -Skip:${SkipTest} {
        [Scriptblock]::Create(@"
        configuration DSCTestConfig
        {
            Import-DscResource -ModuleName PSDesiredStateConfiguration
