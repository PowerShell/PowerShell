...
'@
    ...
    It "Test-Json throw if a path to a schema from file is invalid" {
        ...
        { Test-Json -Path $validJsonPath -SchemaFile $missingSchemaJsonPath -ErrorAction Stop } | Should -Throw -ExpectedMessage "Cannot find JSON schema file: $missingSchemaJsonPath"
    }
