...
"@
    ...
    It "ConvertTo-CliXml should serialize integers correctly using ValueFromPipeline" {
        $testObject = 1,2,3
    ...
    It "ConvertTo-CliXml using default depth of 2 should work" {
        $testObject = [One]::New()
        $content = $testObject | ConvertTo-CliXml
        $testObject | Export-Clixml -Path $testfile
        $content | Should -Be (Get-Content -Path $testfile -Raw)
    ...
    It "ConvertTo-CliXml using -Depth 3 should work" {
        $testObject = [One]::New()
    ...
    It "ConvertTo-CliXml should serialize array correctly using ValueFromPipeline" {
        $testObject = @(1,2,3,4)
        $content = $testObject | ConvertTo-CliXml
        $testObject | Export-CliXml -Path $testfile
        $content | Should -Be (Get-Content -Path $testfile -Raw)
    ...
    It "ConvertTo-CliXml should serialize array correctly using -InputObject" {
        $testObject = @(1,2,3,4)
    ...
    It "ConvertTo-CliXml should serialize hashtable correctly" {
    ...
    It "ConvertTo-CliXml should serialize PSCustomObject correctly" {
    ...
    It "ConvertTo-CliXml should serialize nested PSCustomObject correctly" {
    ...
    It "ConvertTo-CliXml should serialize array of PSCustomObjects correctly" {
        $testObject = @(
    ...
    It "ConvertTo-CliXml should serialize array of single PSCustomObject when using ValueFromPipeline" {
        $testObject = @(
            [PSCustomObject]@{ Property = 1 }
        )
        $content = $testObject | ConvertTo-CliXml
    ...
    It "ConvertTo-CliXml should serialize array of single PSCustomObject when using -InputObject" {
        $testObject = @(
            [PSCustomObject]@{ Property = 1 }
        )
        $content = ConvertTo-CliXml -InputObject $testObject
