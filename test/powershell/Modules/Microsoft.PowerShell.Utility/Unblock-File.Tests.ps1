...
Describe "Unblock-File" -Tags "CI" {
    ...
    It "Write an error if a file is read only" {
        ...
        { Unblock-File -LiteralPath $TestFile -ErrorAction Stop } | Should -Throw -ErrorId "System.UnauthorizedAccessException,Microsoft.PowerShell.Commands.UnblockFileCommand"
    }
}
