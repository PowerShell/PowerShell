...
Describe "New-EventLog cmdlet tests" -Tags @('CI', 'RequireAdminOnWindows') {
    ...
    It "should be able to Remove-EventLog -LogName <string> -ComputerName <string>" -Skip:($true) {
    ...
    #CmdLet is NYI - change to -Skip:($NonWinAdmin) when implemented
    It "should be able to Remove-EventLog -Source <string> -ComputerName <string>"  -Skip:($true) {
