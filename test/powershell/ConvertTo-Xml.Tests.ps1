Describe "ConvertTo-Xml DRT Unit Tests" -Tags DRT{
    ...
    It "Test convertto-xml with a depth parameter" {
        ...
        $expectedValue = @"
<?xml version="1.0" encoding="utf-8"?><Objects><Object Type="System.Management.Automation.PSCustomObject"><Property Name="prop1" Type="System.String">val1</Property><Property Name="prop2" Type="System.String">val2</Property></Object></Objects>
"@
    ...
    It "Test convertto-xml with notypeinfo parameter" {
        ...
        $returnObject -is [System.Xml.XmlDocument] | Should Be $true
        $expectedValue = @"
<?xml version="1.0" encoding="utf-8"?><Objects><Object><Property Name="prop1">val1</Property><Property Name="prop2">val2</Property></Object></Objects>
"@
        $returnObject.OuterXml | Should Be $expectedValue
    }
