...
"Alias",  "epsn",                               "Export-PSSession",                   $($FullCLR -or $CoreWindows              ),   "",                 ""
...
"Alias",  "ipsn",                               "Import-PSSession",                   $($FullCLR -or $CoreWindows              ),   "",                 ""
...
"Alias",  "npssc",                              "New-PSSessionConfigurationFile",     $($FullCLR -or $CoreWindows              ),   "ReadOnly",         ""
...
"Cmdlet", "Disable-PSRemoting",                                 ,                     $($FullCLR -or $CoreWindows -or $CoreUnix)
...
"Cmdlet", "Enable-PSRemoting",                                  ,                     $($FullCLR -or $CoreWindows -or $CoreUnix)
