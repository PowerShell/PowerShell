...
- Implement Unicode escape parsing so that unicode characters can be used as arguments, strings or variable names (#3958) (Thanks to @rketihhill!)
- Fixed `Import-Module` on non-windows so modules with NestedModules and RootModules can be imported (#4010)
