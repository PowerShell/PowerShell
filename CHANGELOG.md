...
- Do not pass `ArgumentAst` to `CreateArgument` for `pwsh -encodedarguments` (#5836)
...
- Make `Set-Location` use path with wildcard characters if it exists (#5839)
...
- Replace `HttpListener` link header tests with `WebListener` (#5806) (Thanks @markekraus!)
- Replace `HttpListener` echo tests with `WebListener` (#5840) (Thanks @markekraus!)
- Replace `HttpListener` redirect tests with `WebListener` (#5872) (Thanks @markekraus!)
...
- Update test framework and tests to support Pester version 4 (#6064)
- Update tests in `Microsoft.PowerShell.Management` folder to use Pester 4 Syntax. (#6294)
...
- Refactor Web Cmdlets Tests to Pester 4 Syntax (#6257) (Thanks @markekraus!)
- Update tests in `Modules/CimCmdlets` folder to use Pester 4 Syntax. (#6306)
- Update tests in `Language` folder to use Pester 4 Syntax. (#6304)
- Change `Get-FileHash` tests to use raw bytes (#6430)
- Remove `runas.exe` from tests as we have tags to control this behavior (#6432)
- Update tests in `Engine` folder to use Pester 4 Syntax. (#6298)
...
- Add option to add shell explorer context menu in Windows installer (#5774) (Thanks @bergmeister!)
- Make the shell explorer context menu registry entries platform specific to allow side by side of x86 and `x64`. (#5824) (Thanks @bergmeister!)
