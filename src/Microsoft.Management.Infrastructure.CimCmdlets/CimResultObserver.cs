...
namespace Microsoft.Management.Infrastructure.CimCmdlets
{
    ...
    internal class AsyncResultCompleteEventArgs : AsyncResultEventArgsBase
    {
        ...
        public AsyncResultCompleteEventArgs(
            CimSession session,
            IObservable<object> observable) : base(session, observable, AsyncResultType.Completion)
        {
        }
    }
    ...
    internal class AsyncResultObjectEventArgs : AsyncResultEventArgsBase
    {
        ...
        public AsyncResultObjectEventArgs(
            CimSession session,
            IObservable<object> observable,
            object resultObject) : base(session, observable, AsyncResultType.Result)
        {
    ...
    internal class AsyncResultErrorEventArgs : AsyncResultEventArgsBase
    {
        ...
        public AsyncResultErrorEventArgs(
            CimSession session,
            IObservable<object> observable,
            Exception error) : base(session, observable, AsyncResultType.Exception)
        {
            this.error = error;
        }
        ...
        public AsyncResultErrorEventArgs(
            ...
            IObservable<object> observable,
            Exception error,
            CimResultContext cimResultContext) : base(session, observable, AsyncResultType.Exception, cimResultContext)
        {
            this.error = error;
        }
