...
namespace Microsoft.Management.Infrastructure.Generic
{
    /// <summary>
    /// <para>
    /// CimAsyncMultipleResults represents an asynchronous operation that returns a sequence of objects of type <typeparamref name="T"/>.
    /// </para>
    /// <para>
    /// The operation wrapped by CimAsyncMultipleResults doesn't start until the <see cref="Subscribe"/> method is called.
