...
namespace Microsoft.PowerShell.Commands
{
    ...
    public abstract class WebRequestPSCmdlet : PSCmdlet, IDisposable
    {
        ...
        /// </summary>
        internal bool ShouldResume => Resume.IsSpecified && _resumeSuccess;
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                bool keepAuthorizationOnRedirect = PreserveAuthorizationOnRedirect.IsSpecified
        ...
        internal virtual void ValidateParameters()
        {
            ...
            // Output ??
            if (PassThru.IsSpecified && OutFile is null)
            {
            ...
            if (Resume.IsSpecified && OutFile is null)
            {
            ...
            if (Resume.IsSpecified && Directory.Exists(_qualifiedOutFile))
            {
        ...
        internal virtual void PrepareSession()
        {
            ...
            WebSession.SkipCertificateCheck = SkipCertificateCheck.IsSpecified;
