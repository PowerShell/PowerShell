...
namespace Microsoft.PowerShell.Commands
{
    ...
    public sealed class AddTypeCommand : PSCmdlet
    {
        ...
        [AllowNull]
        [Alias("NS")]
        public String Namespace  = "Microsoft.PowerShell.Commands.AddType.AutoGeneratedTypes";
        ...
        protected override void EndProcessing()
        {
            ...
            if (loadAssembly)
            {
                // File extension is ".DLL" (ParameterSetName = "FromPath" or "FromLiteralPath").
        ...
        private void CSharpSourceCodeProcessing()
        {
            ...
            else if (String.Equals(ParameterSetName, "FromSource", StringComparison.OrdinalIgnoreCase))
            {
                var sourceText = SourceText.From(_sourceCode);
                _syntaxTrees.Add(CSharpSyntaxTree.ParseText(sourceText, _csharpParseOptions));
            }
