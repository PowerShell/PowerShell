...
namespace Microsoft.PowerShell.Commands
{
    ...
    public sealed class AddTypeCommand : PSCmdlet
    {
        ...
        public string OutputAssembly
        {
            ...
            set
            {
                ...
                if (_outputAssembly != null)
                {
                    ...
                    var newPaths = new Collection<string>();
        ...
        {
            var usingNamespaceSet = new StringBuilder();
        ...
        {
            var visitor = new AllNamedTypeSymbolsVisitor();
        ...
        private string BuildErrorMessage(Diagnostic diagnisticRecord)
        {
            ...
            else
            {
                ...
                var sb = new StringBuilder(diagnisticMessage.Length + errorLineString.Length * 2 + 4);
