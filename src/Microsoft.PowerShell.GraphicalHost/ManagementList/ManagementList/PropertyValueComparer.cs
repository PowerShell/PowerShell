//-----------------------------------------------------------------------
// <copyright file="PropertyValueComparer.cs" company="Microsoft">
...
namespace Microsoft.Management.UI.Internal
{
    ...
    internal class PropertyValueComparer : IComparer
    {
        ...
        private int CompareData(object firstValue, object secondValue, StringComparison stringComparison)
        {
            ...
            // If the objects are different types do string comparison or numeric comparison
            if (firstType != secondType)
            {
                // If both are numeric leverage LanguagePrimitives automatic conversion on comparison
                if (LanguagePrimitives.IsNumeric(Type.GetTypeCode(firstType)) && LanguagePrimitives.IsNumeric(Type.GetTypeCode(secondType)))
                {
		...
		// otherwise compare them as strings
            ...
            if (firstString != null)
            {
                ...
                Diagnostics.Assert(secondString != null, "different types have been handled above");
