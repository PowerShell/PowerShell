...
namespace Microsoft.PowerShell.Utility.Activities
{
    ...
    public sealed class WriteOutput : PSActivity
    {
        ...
        public WriteOutput()
        {
            this.DisplayName = "Write-Output";
        }

        /// <summary>
        /// Gets the fully qualified name of the command invoked by this activity.
        /// </summary>
        public override string PSCommandName { get { return "Microsoft.PowerShell.Utility\\Write-Output"; } }
        ...
        [ParameterSpecificCategory]
        [DefaultValue(null)]
        public InArgument<System.Management.Automation.SwitchParameter> NoEnumerate { get; set; }
        ...
        protected override ActivityImplementationContext GetPowerShell(NativeActivityContext context)
        {
            ...
            if(NoEnumerate.Expression != null)
            {
                targetCommand.AddParameter("NoEnumerate", NoEnumerate.Get(context));
            }
