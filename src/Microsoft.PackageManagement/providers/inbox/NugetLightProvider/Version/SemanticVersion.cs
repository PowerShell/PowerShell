namespace Microsoft.PackageManagement.NuGetProvider 
{
    ...
    public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        public static SemanticVersion Parse(string version)
        {
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, Resources.Messages.InvalidVersionString, version), "version");
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (other == null)
            {
                throw new ArgumentException(Resources.Messages.TypeMustBeASemanticVersion, "obj");
            }
