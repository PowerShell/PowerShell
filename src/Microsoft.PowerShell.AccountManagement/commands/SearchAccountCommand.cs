...
{
    /// <summary>
    /// The Search-Account cmdlet creates a new local user account.
    /// </summary>
    [Cmdlet(VerbsCommon.Search, "Account",
            HelpUri = "")]
    public class SearchAccountCommand : PSCmdlet
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a switch to search expired user accounts.
        /// </summary>
        [Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                if (AccountStore == ContextType.Machine)
                {
                    ...
                    if (AccountExpired.IsPresent)
                    {
                        user.AdvancedSearchFilter.AccountExpirationDate(DateTime.Now, MatchType.LessThan);
                    }
                }
                else
                {
                    var psuser = new PowerShellUserPrincipal(principalContext);
                    SetADUserPrincipalProperties(psuser);

                    if (AccountExpired.IsPresent)
                    {
                        psuser.AdvancedSearchFilter.AccountExpired();
                    }
    ...
    ///
    /// </summary>
    public class PowerShellPrincipalSearchFilter : AdvancedFilters
    {
        /// <summary>
        ///
        /// </summary>
        public PowerShellPrincipalSearchFilter(Principal p) : base(p)
        {
        }
        ...
        {
            this.AdvancedFilterSet("accountExpires", DateTimeToADString(DateTime.Now), typeof(int), MatchType.LessThan);
            //this.AdvancedFilterSet("accountExpires", 0, typeof(int), MatchType.Equals);
        }
        ...
        internal static string DateTimeToADString(DateTime dateTime)
        {
            ...
            return fileTime.ToString(System.Globalization.CultureInfo.InvariantCulture);
        }
    }
    ...
    public class PowerShellUserPrincipal : UserPrincipal
    {
        /// <summary>
        ///
        /// </summary>
        public PowerShellUserPrincipal(PrincipalContext context)
            : base(context)
        { }
        ...
        PowerShellPrincipalSearchFilter _searchFilter;

        /// <summary>
        ///
        /// </summary>
        new public PowerShellPrincipalSearchFilter AdvancedSearchFilter
        {
            get { return _searchFilter ?? (_searchFilter = new PowerShellPrincipalSearchFilter(this)); }
        }
    }
}
