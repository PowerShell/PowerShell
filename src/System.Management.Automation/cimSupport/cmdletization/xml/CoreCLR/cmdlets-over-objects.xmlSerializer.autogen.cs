...
namespace Microsoft.PowerShell.Cmdletization.Xml
{
    internal class XmlSerializationReader1
    {
        ...
        {
            return new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, $"XmlUnknownType. Name: {type.Name}, Namespace {type.Namespace}, CurrentTag: {CurrentTag()}"));
        }

        protected Exception CreateUnknownConstantException(string value, Type enumType)
        {
            return new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, $"XmlUnknownConstant. Value: {value}, EnumType: {enumType.Name}"));
        }
        ...
        internal XmlQualifiedName ToXmlQualifiedName(string value, bool decodeName)
        {
            ...
            else
            {
                ...
                if (ns == null)
                {
                    ...
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, $"XmlUndefinedAlias. Prefix: {prefix}"));
                }
