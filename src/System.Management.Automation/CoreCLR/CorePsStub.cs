...
// There is no plan to support DataTable in ProjectK
namespace System.Data
{
    internal class DataTable
    {
        internal DataRowCollection Rows { get; set; }
    }

    internal sealed class DataRowCollection : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
            throw new NotImplementedException("You are calling into the stub for 'DataRowCollection.GetEnumerator()'. It's not implemented.");
        }
    }
}
