...
namespace System.Management.Automation
{
    ...
    internal static class CatalogHelper
    {
        ...
        private static readonly int catalogVersion1 = 256;

        // Catalog Version is (0X200 = 512) for Catalog Version 2
        private static readonly int catalogVersion2 = 512;

        // Hash Algorithms supported by Windows Catalog
        private static readonly string HashAlgorithmSHA1 = "SHA1";
        private static readonly string HashAlgorithmSHA256 = "SHA256";
