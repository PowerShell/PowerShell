...
{
    /// <summary>
    /// <param>Represents a set of access rights allowed or denied for a user or group. This class cannot be inherited.</param>
    /// </summary>
    ...
    public sealed class TransactedRegistryAccessRule : AccessRule
    {
        ...
        /// <summary>
        /// <param>Initializes a new instance of the RegistryAccessRule class, specifying the user or group the rule applies to,
        /// the access rights, and whether the specified access rights are allowed or denied.</param>
        ...
        /// <summary>
        /// <param>Gets the rights allowed or denied by the access rule.</param>
        /// </summary>
    ...
    /// <summary>
    /// <param>Represents a set of access rights to be audited for a user or group. This class cannot be inherited.</param>
    /// </summary>
    // Suppressed because these are needed to manipulate TransactedRegistryKey, which is written to the pipeline.
    [SuppressMessage("Microsoft.MSInternal", "CA903:InternalNamespaceShouldNotContainPublicTypes")]
    ...
    {
        /// <summary>
        /// <param>Initializes a new instance of the RegistryAuditRule class, specifying the user or group to audit, the rights to
        /// audit, whether to take inheritance into account, and whether to audit success, failure, or both.</param>
        /// <param name="identity">The user or group the rule applies to. Must be of type SecurityIdentifier or a type such as
        /// NTAccount that can be converted to type SecurityIdentifier.</param>
        ...
        /// <summary>
        /// <param>Gets the access rights affected by the audit rule.</param>
        /// </summary>
        public RegistryRights RegistryRights
        {
            get { return (RegistryRights)base.AccessMask; }
    ...
    /// <summary>
    /// <param>Represents the Windows access control security for a registry key. This class cannot be inherited.
    /// This class is specifically to be used with TransactedRegistryKey.</param>
    /// </summary>
    // Suppressed because these are needed to manipulate TransactedRegistryKey, which is written to the pipeline.
    [SuppressMessage("Microsoft.MSInternal", "CA903:InternalNamespaceShouldNotContainPublicTypes")]
    public sealed class TransactedRegistrySecurity : NativeObjectSecurity
    {
        ...
        /// <summary>
        /// <param>Initializes a new instance of the TransactedRegistrySecurity class with default values.</param>
        /// </summary>
        ...
        */
        ...
        /// <summary>
        /// <param>Creates a new access control rule for the specified user, with the specified access rights, access control, and flags.</param>
        ...
        /// <summary>
        /// <param>Creates a new audit rule, specifying the user the rule applies to, the access rights to audit, the inheritance and propagation of the
        /// rule, and the outcome that triggers the rule.</param>
        /// <param name="identityReference">An IdentityReference that identifies the user or group the rule applies to.</param>
        ...
        /// <summary>
        /// <param>Searches for a matching access control with which the new rule can be merged. If none are found, adds the new rule.</param>
        ...
        /// <summary>
        /// <param>Removes all access control rules with the same user and AccessControlType (allow or deny) as the specified rule, and then adds the specified rule.</param>
        ...
        /// <summary>
        /// <param>Removes all access control rules with the same user as the specified rule, regardless of AccessControlType, and then adds the specified rule.</param>
        ...
        /// <summary>
        /// <param>Searches for an access control rule with the same user and AccessControlType (allow or deny) as the specified access rule, and with compatible
        /// inheritance and propagation flags; if such a rule is found, the rights contained in the specified access rule are removed from it.</param>
        ...
        /// <summary>
        /// <param>Searches for all access control rules with the same user and AccessControlType (allow or deny) as the specified rule and, if found, removes them.</param>
        ...
        /// <summary>
        /// <param>Searches for an access control rule that exactly matches the specified rule and, if found, removes it.</param>
        ...
        /// <summary>
        /// <param>Searches for an audit rule with which the new rule can be merged. If none are found, adds the new rule.</param>
        ...
        /// <summary>
        /// <param>Removes all audit rules with the same user as the specified rule, regardless of the AuditFlags value, and then adds the specified rule.</param>
        ...
        /// <summary>
        /// <param>Searches for an audit control rule with the same user as the specified rule, and with compatible inheritance and propagation flags;
        /// if a compatible rule is found, the rights contained in the specified rule are removed from it.</param>
        ...
        /// <summary>
        /// <param>Searches for all audit rules with the same user as the specified rule and, if found, removes them.</param>
        ...
        /// <summary>
        /// <param>Searches for an audit rule that exactly matches the specified rule and, if found, removes it.</param>
        ...
        /// <summary>
        /// <param>Gets the enumeration type that the TransactedRegistrySecurity class uses to represent access rights.</param>
        ...
        /// <summary>
        /// <param>Gets the type that the TransactedRegistrySecurity class uses to represent access rules.</param>
        ...
        /// <summary>
        /// <param>Gets the type that the TransactedRegistrySecurity class uses to represent audit rules.</param>
