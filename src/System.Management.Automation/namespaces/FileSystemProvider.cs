                                                     ...
                                                     ICmdletProviderSupportsHelp
    {
        ...
        protected override void InvokeDefaultAction(string path)
        {
            ...
            if (ShouldProcess(resource, action))
            {
                ...
                // codeql[cs/microsoft/command-line-injection-shell-execution] - This is expected PowerShell behavior where user inputted paths are supported for the context of this method. The user assumes trust for the file path they are specifying. If there is concern for remoting, restricted remoting guidelines should be used.
