...
namespace System.Management.Automation
{
    ...
    internal static class EncodingConversion
    {
        ...
        internal class ByteEncoding : System.Text.Encoding
        {
            ...
            public override string GetString(byte[] b) { throw new NotImplementedException(); }
            public override string GetString(byte[] b, int i1, int i2) { throw new NotImplementedException(); }
        ...
        public override object Transform(EngineIntrinsics engineIntrinsics, object inputData)
        {
            ...
            if (LanguagePrimitives.TryConvertTo<string>(inputData, out encodingName))
            {
                if (string.Equals(encodingName, EncodingConversion.Unknown, StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(encodingName, EncodingConversion.Byte, StringComparison.OrdinalIgnoreCase) ||
                    ...
                    string.Equals(encodingName, EncodingConversion.Utf8Bom, StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(encodingName, EncodingConversion.Utf8NoBom, StringComparison.OrdinalIgnoreCase) ||
