...
namespace Microsoft.PowerShell.Telemetry
{
    ...
    public static class ApplicationInsightsTelemetry
    {
        ...
        private static readonly Lazy<HashSet<string>> s_knownModules;
        ...
        private static HashSet<string> GetKnownModules()
        {
        ...
        private static string GetExperimentalFeatureName(string featureNameToValidate)
        {
            ...
            if (s_knownModules.Value.Contains(moduleName))
            {
        ...
        {
            if (s_knownModules.Value.Contains(moduleNameToValidate))
            {
