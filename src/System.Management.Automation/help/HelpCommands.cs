...
namespace Microsoft.PowerShell.Commands
{
    ...
    public sealed class GetHelpCommand : PSCmdlet
    {
        ...
        private PSObject TransformView(PSObject originalHelpObject)
        {
            ...
            {
                string typeToAdd = string.Format(CultureInfo.InvariantCulture, $"HelpInfo#{tokenToAdd}");
            ...
            else
            {
                ...
                foreach (string typeName in originalHelpObject.TypeNames)
                {
                    ...
                    string typeToAdd = string.Format(CultureInfo.InvariantCulture, $"{typeName}#{tokenToAdd}");
