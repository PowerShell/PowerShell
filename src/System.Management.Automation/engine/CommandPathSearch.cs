    ...
    internal class CommandPathSearch : IEnumerable<String>, IEnumerator<String>
    {
            ...
            Collection<string> acceptableCommandNames)
        {
            ...
            if (acceptableCommandNames != null)
            {
                ...
                var commandNamePattern = commandName + ".*";
                if (Platform.IsWindows)
                {
                    commandPatterns = new [] { commandNamePattern };
                }
                else
                {
                    ...
                    // called with their extensions, so that 'script.ps1' can be called by 'script'.
                    commandPatterns = new [] { commandName, commandNamePattern };
                }
