    ...
    internal static class PSSnapInHelpers
    {
            ...
            string helpFile)
        {
            cmdlets = new Dictionary<string, SessionStateCmdletEntry>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "Get-ArgumentCompleter",             new SessionStateCmdletEntry("Get-ArgumentCompleter", typeof(GetArgumentCompleterCommand), helpFile) },
                ...
                { "Unregister-ArgumentCompleter",      new SessionStateCmdletEntry("Unregister-ArgumentCompleter", typeof(UnregisterArgumentCompleterCommand), helpFile) },
