...
";
        ...
        internal static SessionStateFunctionEntry[] BuiltInFunctions = new SessionStateFunctionEntry[]
        {
           // Functions that don't require full language mode
            ...
            SessionStateFunctionEntry.GetDelayParsedFunctionEntry("help", HelpSystemBase.GetHelpPagingFunctionTextMethod(), isProductCode: true, languageMode: systemLanguageMode),
