            ...
            int debugEndColNumber)
        {
            ...
            if (_parentScriptBlockAst != null)
            {
                ...
                StatementAst callingStatement = _parentScriptBlockAst.Find(
                    ast => ((ast is StatementAst) && (ast.Extent.StartLineNumber == callingLineNumber))
                ...
                if (callingStatement != null)
                {
                    ...
                    StatementAst firstStatement = callingStatement.Find(ast => ((ast is StatementAst) && ast.Extent.StartLineNumber > callingLineNumber), true) as StatementAst;
                    if (firstStatement != null)
                    {
                        int adjustedLineNumber = firstStatement.Extent.StartLineNumber + debugLineNumber - 1;
                        debugStatement = callingStatement.Find(ast => ((ast is StatementAst) && ast.Extent.StartLineNumber == adjustedLineNumber), true) as StatementAst;
                    }
                }
