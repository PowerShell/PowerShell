...
namespace System.Management.Automation
{
    ...
    public sealed class ValidateSetAttribute : ValidateEnumeratedArgumentsAttribute
    {
        ...
        /// <summary>
        /// Gets or sets a flag indicating that the validation is disabled.
        /// If the validation is disabled, it will always return true.
        /// </summary>
        public bool Disabled { get; set; } = false;

        /// <summary>
        /// An optional Name.  This is used to identify this validation.
        /// </summary>
