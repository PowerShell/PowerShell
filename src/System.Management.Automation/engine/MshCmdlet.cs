...
namespace System.Management.Automation
{
    ...
    public class CommandInvocationIntrinsics
    {
        ...
        {
            return InvokeScript(script, useNewScope: true, PipelineResultTypes.None, null);
        }
        ...
        {
            return InvokeScript(script, useNewScope: true, PipelineResultTypes.None, null, args);
        }
        ...
        /// <returns>A collection of the PSObjects emitted by the executing scriptblock.</returns>
        ...
        /// </summary>
        /// <param name="useNewScope">If true, a new scope will be created.</param>
        /// <param name="scriptBlock">The scriptblock to execute.</param>
        /// <param name="input">Optionall input to the command.</param>
        /// <param name="args">Arguments to pass to the scriptblock.</param>
        /// <returns>
        /// A collection of the PSObjects generated by executing the script.
        /// </returns>
        public Collection<PSObject> InvokeScript(
            bool useNewScope,
            ScriptBlock scriptBlock,
            ...
            params object[] args)
        {
            ...
            try
            {
                return InvokeScript(scriptBlock, useNewScope, PipelineResultTypes.None, input, args);
            }
            finally
            {
