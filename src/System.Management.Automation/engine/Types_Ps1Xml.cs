...
namespace System.Management.Automation.Runspaces
{
    internal sealed class Types_Ps1Xml
    {
        ...
        public static IEnumerable<TypeData> Get()
        {
          ...
          $iphost.AddressList | Where-Object { $_.AddressFamily -eq [System.Net.Sockets.AddressFamily]::InterNetwork } | select -first 1"), null));
          ...
          $iphost.AddressList | Where-Object { $_.AddressFamily -eq [System.Net.Sockets.AddressFamily]::InterNetworkV6 } | select -first 1"), null));
            yield return td24;
          ...
          $helpUri = [string]$( $helpObject.relatedLinks.navigationLink | ForEach-Object { if ($_.psobject.properties['uri'] -ne $null) { $_.uri } } | Where-Object { $_ } | select -first 1 )
          return $helpUri
          }
          else
          {
