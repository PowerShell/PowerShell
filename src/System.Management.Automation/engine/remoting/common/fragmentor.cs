...
namespace System.Management.Automation.Remoting
{
    ...
    internal class FragmentedRemoteObject
    {
        ...
        internal FragmentedRemoteObject(byte[] blob, long objectId, long fragmentId,
            bool isEndFragment)
        {
            Dbg.Assert((blob is not null) || (blob.Length == 0), "Cannot create a fragment for null or empty data.");
        ...
        internal byte[] Blob
        {
            ...
            set
            {
                Dbg.Assert(value is not null, "Blob cannot be null");
                _blob = value;
            }
        }
        ...
        {
            Dbg.Assert(fragmentBytes is not null, "fragmentBytes cannot be null");
        ...
        {
            Dbg.Assert(fragmentBytes is not null, "fragment cannot be null");
    ...
    internal class SerializedDataStream : Stream, IDisposable
    {
        ...
        {
            if (callbackToNotify is not null)
            {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                lock (_syncObject)
                {
                    ...
                    if ((_readStream is not null) && (_readStream.CanRead))
                    {
                        _readStream.Dispose();
                    }

                    if ((_writeStream is not null) && (_writeStream.CanRead))
                    {
    ...
    internal class Fragmentor
    {
        ...
        {
            Dbg.Assert(obj is not null, "Cannot fragment a null object");
            Dbg.Assert(dataToBeSent is not null, "SendDataCollection cannot be null");
        ...
        {
            Dbg.Assert(obj is not null, "Cannot serialize a null object");
        ...
        {
            Dbg.Assert(serializedDataStream is not null, "Cannot Deserialize null data");
