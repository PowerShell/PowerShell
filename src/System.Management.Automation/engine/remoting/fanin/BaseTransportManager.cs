    ...
    internal abstract class AbstractServerTransportManager : BaseTransportManager
    {
        ...
        internal void SendDataToClient<T>(RemoteDataObject<T> data, bool flush, bool reportPending = false)
        {
            ...
            lock (_syncObject)
            {
                ...
                //        Update-TypeData -TypeName Microsoft.PowerShell.Test.Bug491001 -MemberType ScriptProperty -MemberName name -Value {( 1..50kb | ForEach-Object { get-random -min 97 -max 122 | ForEach-Object  { [char]$psitem } }) -join ""}
                ...
                //        Update-TypeData -TypeName Microsoft.PowerShell.Test.Bug491001 -MemberType ScriptProperty -MemberName zname -Value {( 1..10kb | ForEach-Object { get-random -min 97 -max 122 | ForEach-Object  { [char]$psitem } }) -join ""}
                //        $a
                //   }
