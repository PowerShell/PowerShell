    ...
    public class ReceiveJobCommand : JobCmdletBase, IDisposable
    {
        ...
        protected void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (_jobsBeingAggregated is not null)
                {
        ...
        private void WriteJobResults(Job job)
        {
            ...
            {
                PSRemotingChildJob remotingChildJob = job as PSRemotingChildJob;
                if (remotingChildJob is not null && remotingChildJob.DisconnectedAndBlocked)
                {
                    return;
                }
            }
        ...
        private void WriteReasonError(Job job)
        {
            ...
            if (child is not null && child.FailureErrorRecord is not null)
            {
                _results.Add(new PSStreamObject(PSStreamObjectType.Error, child.FailureErrorRecord, child.InstanceId));
            }
            else if (job.JobStateInfo.Reason is not null)
            {
                ...
                if (exceptionWithLocation is not null)
                {
                ...
                if ((exceptionWithLocation is not null) && (exceptionWithLocation.DisplayScriptPosition is not null))
                {
        ...
        private void ResultsAdded(object sender, DataAddedEventArgs e)
        {
            ...
            Dbg.Assert(results is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void HandleJobStateChanged(object sender, JobStateEventArgs e)
        {
            ...
            Dbg.Assert(job is not null, "Job state info cannot be raised with reference to job");
        ...
        private void Progress_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Diagnostics.Assert(progressRecords is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void Error_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Diagnostics.Assert(errorRecords is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void Debug_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Diagnostics.Assert(debugRecords is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void Warning_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Diagnostics.Assert(warningRecords is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void Verbose_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Dbg.Assert(verboseRecords is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void Information_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Dbg.Assert(informationRecords is not null, "PSDataCollection is raising an inappropriate event");
        ...
        private void Output_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            try
            {
                ...
                Dbg.Assert(output is not null, "PSDataCollection is raising an inappropriate event");
...
#pragma warning restore 56500
        ...
        private void SetOutputProcessingState(bool processingOutput)
        {
            ...
            if (_outputProcessingNotification is not null && stateChanged)
            {
