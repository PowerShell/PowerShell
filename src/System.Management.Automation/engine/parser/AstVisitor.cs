...
namespace System.Management.Automation.Language
{
    ...
    {
        /// <summary/>
        object VisitListExpression(ListExpressionAst listExpressionAst);
    }
    ...
    class CheckAllParentsSet : AstVisitor3
    {
        ...
        public override AstVisitAction VisitListExpression(ListExpressionAst ast) { return CheckParent(ast); }
    ...
    internal class AstSearcher : AstVisitor3
    {
        ...
        public override AstVisitAction VisitListExpression(ListExpressionAst ast) { return Check(ast); }
    ...
    {
        /// <summary/>
        public virtual object VisitListExpression(ListExpressionAst listExpressionAst) { return null; }
    }
}
