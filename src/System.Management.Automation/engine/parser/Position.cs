        ...
        public string Text
        {
            get
            {
                if (EndColumnNumber > 0)
                {
                    ...
                    return string.Create(CultureInfo.InvariantCulture, $"{_startPosition.Line.Substring(_startPosition.ColumnNumber)}...{ _endPosition.Line.Substring(0, _endPosition.ColumnNumber)}");
                }
                else
                {
                    return string.Empty;
