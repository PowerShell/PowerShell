...
namespace System.Management.Automation.Language
{
    ...
    public abstract class Ast
    {
        ...
        public object SafeGetValue()
        {
            try
            {
                ...
                if (System.Management.Automation.Runspaces.Runspace.DefaultRunspace is not null)
                {
        ...
        internal void SetParent(Ast child)
        {
            ...
            Diagnostics.Assert(child.Parent is null, "Parent can only be set once");
            child.Parent = this;
        }
        ...
        internal bool IsInWorkflow()
        {
            ...
            while (current is not null && !stopScanning)
            {
            ...
            out DynamicKeywordStatementAst keywordAst)
        {
            ...
            configAst = (keywordAst is not null) ? GetAncestorAst<ConfigurationDefinitionAst>(keywordAst) : GetAncestorAst<ConfigurationDefinitionAst>(ast);
            return configAst;
        }
        ...
        internal static TypeDefinitionAst GetAncestorTypeDefinitionAst(Ast ast)
        {
            ...
            while (ast is not null)
            {
                ...
                if (functionDefinitionAst is not null && !(functionDefinitionAst.Parent is FunctionMemberAst))
                    break;
                ast = ast.Parent;
            }
    ...
    public class ErrorStatementAst : PipelineBaseAst
    {
        internal ErrorStatementAst(IScriptExtent extent, IEnumerable<Ast> nestedAsts = null)
            : base(extent)
        {
            if (nestedAsts is not null && nestedAsts.Any())
            {
        ...
        public override Ast Copy()
        {
            ...
            else if (Flags is not null || Conditions is not null || Bodies is not null)
            {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (action == AstVisitAction.Continue && NestedAst is not null)
            {
            ...
            if (action == AstVisitAction.Continue && Flags is not null)
            {
            ...
            if (action == AstVisitAction.Continue && Conditions is not null)
            {
            ...
            if (action == AstVisitAction.Continue && Bodies is not null)
            {
    ...
    public class ScriptBlockAst : Ast, IParameterMetadataProvider
    {
            ...
            : base(extent)
        {
            ...
            if (dynamicParamBlock is not null)
            {
        ...
        private ScriptBlockAst GetRootScriptBlockAst()
        {
            ...
            while ((parent = Ast.GetAncestorAst<ScriptBlockAst>(rootScriptBlockAst.Parent)) is not null)
            {
        ...
        {
            Diagnostics.Assert(usingVariablesTuple.Item1 is not null && usingVariablesTuple.Item1.Count > 0 && !string.IsNullOrEmpty(usingVariablesTuple.Item2),
            ...
            foreach (var ast in astElements.OrderBy(ast => ast.Extent.StartOffset))
            {
                ...
                else
                {
                    ...
                    Diagnostics.Assert(paramAst is not null, "The elements in astElements are either ParamBlockAst or VariableExpressionAst");
            ...
            if (Parent is not null && initialStartOffset == this.Extent.StartOffset && initialEndOffset == this.Extent.EndOffset)
            {
                // Parent is FunctionDefinitionAst or ScriptBlockExpressionAst
                // The extent includes curlies which we want to exclude.
                Diagnostics.Assert(result[0] == '{' && result[result.Length - 1] == '}',
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.Continue && ParamBlock is not null)
                action = ParamBlock.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && DynamicParamBlock is not null)
                action = DynamicParamBlock.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && BeginBlock is not null)
                action = BeginBlock.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && ProcessBlock is not null)
                action = ProcessBlock.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && EndBlock is not null)
        ...
        {
            return Attributes.Count > 0 || ParamBlock is not null && ParamBlock.Attributes.Count > 0;
        }
        ...
        IEnumerable<ExperimentalAttribute> IParameterMetadataProvider.GetExperimentalAttributes()
        {
            for (int index = 0; index < Attributes.Count; index++)
            {
                ...
                if (expAttr is not null) { yield return expAttr; }
            }
            ...
            ExperimentalAttribute GetExpAttributeHelper(AttributeAst attributeAst)
            {
                ...
                if (potentialExpAttr is not null)
                {
                    try
                    {
        ...
        {
            get { return (ParamBlock is not null) ? this.ParamBlock.Parameters : null; }
        }
        ...
        private string GetWithInputHandlingForInvokeCommandImpl(Tuple<List<VariableExpressionAst>, string> usingVariablesTuple)
        {
            ...
            {
                return (usingVariablesTuple is null)
            ...
            if (ParamBlock is not null)
            {
                string paramText = (usingVariablesTuple is null)
                    ? ParamBlock.ToString()
            ...
            sb.Append("$input |");
            string pipelineText = (usingVariablesTuple is null)
        ...
        {
            if (BeginBlock is not null || ProcessBlock is not null || DynamicParamBlock is not null)
            {
            ...
            if (EndBlock is null || EndBlock.Statements.Count < 1)
            {
            ...
            if (EndBlock.Traps is not null && EndBlock.Traps.Count > 0)
            {
    ...
    public class ParamBlockAst : Ast
    {
        ...
        internal static bool UsesCmdletBinding(IEnumerable<ParameterAst> parameters)
        {
            ...
            {
                usesCmdletBinding = parameter.Attributes.Any(attribute => (attribute.TypeName.GetReflectionAttributeType() is not null) &&
    ...
    public class NamedBlockAst : Ast
    {
            ...
            : base(extent)
        {
            ...
            if (traps is not null && traps.Count > 0)
            {
                this.Traps = traps;
            ...
            if (!unnamed)
            {
                ...
                if (statementsExtent is not null)
                {
        ...
        public override Ast Copy()
        {
            ...
            if (this.OpenCurlyExtent is not null && this.CloseCurlyExtent is not null)
            {
    ...
    public class ParameterAst : Ast
    {
        ...
        {
            var typeConstraint = Attributes.OfType<TypeConstraintAst>().FirstOrDefault();
            var type = typeConstraint is not null ? typeConstraint.TypeName.FullName : "object";
        ...
        internal string GetParamTextWithDollarUsingHandling(IEnumerator<VariableExpressionAst> orderedUsingVar)
        {
            ...
            if (orderedUsingVar.Current is null && !orderedUsingVar.MoveNext())
            {
                return paramText;
            }
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.Continue && DefaultValue is not null)
            {
    ...
    public class StatementBlockAst : Ast
    {
            ...
            : base(extent)
        {
            ...
            if (traps is not null && traps.Any())
            {
                                                     ...
                                                     AstVisitAction action)
        {
            ...
            if (action == AstVisitAction.Continue && traps is not null)
            {
                for (int index = 0; index < traps.Count; index++)
                {
            ...
            if (action == AstVisitAction.Continue && statements is not null)
            {
                for (int index = 0; index < statements.Count; index++)
                {
    ...
    public class TypeDefinitionAst : StatementAst
    {
            ...
            : base(extent)
        {
            ...
            if (baseTypes is not null && baseTypes.Any())
            {
        ...
        internal Type Type
        {
            ...
            set
            {
                ...
                Diagnostics.Assert(value is null || _type is null || _type is TypeBuilder, "Type must be assigned only once to RuntimeType");
                _type = value;
            }
        }
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            // above test 'visitor2 is not null'.
            if (action == AstVisitAction.Continue)
            {
                for (int index = 0; index < Attributes.Count; index++)
                {
    ...
    public class UsingStatementAst : StatementAst
    {
        ...
        {
            var visitor2 = visitor as ICustomAstVisitor2;
            return visitor2 is not null ? visitor2.VisitUsingStatement(this) : null;
        }
    ...
    public class PropertyMemberAst : MemberAst
    {
        ...
        {
            var type = PropertyType is not null ? PropertyType.TypeName.FullName : "object";
            return IsStatic
                ? "static " + type + " " + Name
                : type + " " + Name;
        }
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (visitor2 is not null)
            {
                ...
                if (action == AstVisitAction.Continue && PropertyType is not null)
                ...
                if (action == AstVisitAction.Continue && InitialValue is not null)
    ...
    public class FunctionMemberAst : MemberAst, IParameterMetadataProvider
    {
        ...
        public FunctionMemberAst(IScriptExtent extent, FunctionDefinitionAst functionDefinitionAst, TypeConstraintAst returnType, IEnumerable<AttributeAst> attributes, MethodAttributes methodAttributes)
            : base(extent)
        {
            if (functionDefinitionAst is null)
            {
        ...
        {
            var visitor2 = visitor as ICustomAstVisitor2;
            return visitor2 is not null ? visitor2.VisitFunctionMember(this) : null;
        }
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (visitor2 is not null)
            {
                ...
                if (action == AstVisitAction.Continue && ReturnType is not null)
        ...
        internal bool IsReturnTypeVoid()
        {
            ...
            return typeName is null ? false : typeName.IsType(typeof(void));
        }

        internal Type GetReturnType()
        {
            return ReturnType is null ? typeof(void) : ReturnType.TypeName.GetReflectionType();
        }
        #endregion
    }
    ...
    internal class CompilerGeneratedMemberFunctionAst : MemberAst, IParameterMetadataProvider
    {
            ...
            : base(extent)
        {
            ...
            Body = new ScriptBlockAst(extent, null, new StatementBlockAst(extent, statement is null ? null : new[] { statement }, null), false);
            this.SetParent(Body);
    ...
    public class FunctionDefinitionAst : StatementAst, IParameterMetadataProvider
    {
        ...
        {
            if (scriptBlockTokenCache is null)
            {
        ...
        {
            Diagnostics.Assert(Parameters is not null, "Caller makes sure that Parameters is not null before calling this method.");

            string additionalNewUsingParams = null;
            IEnumerator<VariableExpressionAst> orderedUsingVars = null;
            if (usingVariablesTuple is not null)
            {
                Diagnostics.Assert(
                    usingVariablesTuple.Item1 is not null && usingVariablesTuple.Item1.Count > 0 && !string.IsNullOrEmpty(usingVariablesTuple.Item2),
                    "Caller makes sure the value passed in is not null or empty.");
            ...
            if (additionalNewUsingParams is not null)
            {
            ...
            for (int i = 0; i < Parameters.Count; i++)
            {
                ...
                sb.Append(separator);
                sb.Append(orderedUsingVars is not null
        ...
        ReadOnlyCollection<ParameterAst> IParameterMetadataProvider.Parameters
        {
            get { return Parameters ?? (Body.ParamBlock is not null ? Body.ParamBlock.Parameters : null); }
        }
        ...
        string IParameterMetadataProvider.GetWithInputHandlingForInvokeCommand()
        {
            ...
            return Parameters is null ? result : (GetParamTextFromParameterList() + result);
        }
        ...
        bool IParameterMetadataProvider.UsesCmdletBinding()
        {
            ...
            else if (Body.ParamBlock is not null)
            {
    ...
    public class IfStatementAst : StatementAst
    {
        ...
        public IfStatementAst(IScriptExtent extent, IEnumerable<IfClause> clauses, StatementBlockAst elseClause)
            : base(extent)
        {
            if (clauses is null || !clauses.Any())
            {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.Continue && ElseClause is not null)
            {
    ...
    public class DataStatementAst : StatementAst
    {
            ...
            : base(extent)
        {
            ...
            if (commandsAllowed is not null && commandsAllowed.Any())
            {
    ...
    public class ForEachStatementAst : LoopStatementAst
    {
        ...
        {
            if (expression is null || variable is null)
            {
                throw PSTraceSource.NewArgumentNullException(expression is null ? "expression" : "variablePath");
            }
        ...
        public override Ast Copy()
        {
            ...
            if (this.ThrottleLimit is not null)
            {
    ...
    public class ForStatementAst : LoopStatementAst
    {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (action == AstVisitAction.Continue && Initializer is not null)
                action = Initializer.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && Condition is not null)
                action = Condition.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && Iterator is not null)
    ...
    public class SwitchStatementAst : LabeledStatementAst
    {
        ...
        public SwitchStatementAst(IScriptExtent extent,
            ...
            : base(extent, label, condition)
        {
            if ((clauses is null || !clauses.Any()) && @default is null)
            {
            ...
            this.Clauses = new ReadOnlyCollection<SwitchClause>(
                (clauses is not null && clauses.Any()) ? clauses.ToArray() : s_emptyClauseArray);
            SetParents(Clauses);
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.Continue && Default is not null)
    ...
    public class TryStatementAst : StatementAst
    {
            ...
            : base(extent)
        {
            ...
            if ((catchClauses is null || !catchClauses.Any()) && @finally is null)
            {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.Continue && Finally is not null)
    ...
    public class TrapStatementAst : StatementAst
    {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (action == AstVisitAction.Continue && TrapType is not null)
    ...
    public class BreakStatementAst : StatementAst
    {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (action == AstVisitAction.Continue && Label is not null)
    ...
    public class ReturnStatementAst : StatementAst
    {
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (action == AstVisitAction.Continue && Pipeline is not null)
    ...
    public class PipelineAst : ChainableAst
    {
        ...
        public PipelineAst(IScriptExtent extent, IEnumerable<CommandBaseAst> pipelineElements, bool background)
            : base(extent)
        {
            if (pipelineElements is null || !pipelineElements.Any())
            {
        ...
        public override ExpressionAst GetPureExpression()
        {
            ...
            if (expr is not null && expr.Redirections.Count == 0)
            {
    ...
    public class CommandParameterAst : CommandElementAst
    {
        ...
        public CommandParameterAst(IScriptExtent extent, string parameterName, ExpressionAst argument, IScriptExtent errorPosition)
            : base(extent)
        {
            if (errorPosition is null || string.IsNullOrEmpty(parameterName))
            {
                throw PSTraceSource.NewArgumentNullException(errorPosition is null ? "errorPosition" : "parameterName");
            }
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (Argument is not null && action == AstVisitAction.Continue)
            {
                action = Argument.InternalVisit(visitor);
            }
    ...
    public class CommandAst : CommandBaseAst
    {
        ...
        {
            if (commandElements is null || !commandElements.Any())
            {
        ...
        public string GetCommandName()
        {
            ...
            return name is not null ? name.Value : null;
        }
    ...
    public class AssignmentStatementAst : PipelineBaseAst
    {
        ...
        public AssignmentStatementAst(IScriptExtent extent, ExpressionAst left, TokenKind @operator, StatementAst right, IScriptExtent errorPosition)
            : base(extent)
        {
            if (left is null || right is null || errorPosition is null)
            {
                throw PSTraceSource.NewArgumentNullException(left is null ? "left" : right is null ? "right" : "errorPosition");
            }
        ...
        public IEnumerable<ExpressionAst> GetAssignmentTargets()
        {
            ...
            if (arrayExpression is not null)
            {
    ...
    public class ConfigurationDefinitionAst : StatementAst
    {
        ...
        public override Ast Copy()
        {
            ...
            return new ConfigurationDefinitionAst(Extent, body, ConfigurationType, instanceName)
            {
                ...
                CustomAttributes = this.CustomAttributes is null ? null : this.CustomAttributes.Select(e => (AttributeAst)e.Copy())
            };
        }
        ...
        {
            var visitor2 = visitor as ICustomAstVisitor2;
            return visitor2 is not null ? visitor2.VisitConfigurationDefinition(this) : null;
        }
        ...
        internal PipelineAst GenerateSetItemPipelineAst()
        {
            ...
            var scriptBlockBody = new ScriptBlockAst(Body.Extent,
                CustomAttributes is null ? null : CustomAttributes.Select(att => (AttributeAst)att.Copy()).ToList(),
                null,
            ...
            if (Body.ScriptBlock.ParamBlock is not null)
            {
        ...
        private static bool IsImportCommand(StatementAst stmt, List<Tuple<string[], ModuleSpecification[], Version>> resourceModulePairsToImport)
        {
            ...
            if (dkwsAst is null || !dkwsAst.Keyword.Keyword.Equals("Import-DscResource", StringComparison.OrdinalIgnoreCase))
            {
                return false;
            }
            ...
            if (moduleVersion is not null)
            {
                ...
                if (moduleNamesTyped is not null && moduleNamesTyped.Length == 1)
                {
        ...
        private static IEnumerable<ParameterAst> ConfigurationBuildInParameters
        {
            get
            {
                if (s_configurationBuildInParameters is null)
                {
        ...
        private static IEnumerable<AttributeAst> ConfigurationBuildInParameterAttribAsts
        {
            get
            {
                if (s_configurationBuildInParameterAttrAsts is null)
                {
        ...
        private static IEnumerable<StatementAst> ConfigurationExtraParameterStatements
        {
            get
            {
                if (s_configurationExtraParameterStatements is null)
                {
    ...
    public class DynamicKeywordStatementAst : StatementAst
    {
        ...
        {
            var visitor2 = visitor as ICustomAstVisitor2;
            return visitor2 is not null ? visitor2.VisitDynamicKeywordStatement(this) : null;
        }
        ...
        {
            if (_commandCallPipelineAst is not null)
    ...
    public abstract class ExpressionAst : CommandElementAst
    {
        ...
        internal virtual bool ShouldPreserveOutputInCaseOfException()
        {
            ...
            if (parenExpr is null && subExpr is null)
            {
                PSTraceSource.NewInvalidOperationException();
            }

            var commandExpr = this.Parent as CommandExpressionAst;
            if (commandExpr is null)
            {
                return false;
            }

            var pipelineAst = commandExpr.Parent as PipelineAst;
            if (pipelineAst is null || pipelineAst.PipelineElements.Count > 1)
            {
                return false;
            }
    ...
    public class BlockStatementAst : StatementAst
    {
        ...
        public BlockStatementAst(IScriptExtent extent, Token kind, StatementBlockAst body)
            : base(extent)
        {
            if (kind is null || body is null)
            {
                throw PSTraceSource.NewArgumentNullException(kind is null ? "kind" : "body");
            }
    ...
    public class AttributedExpressionAst : ExpressionAst, ISupportsAssignment, IAssignableValue
    {
            ...
            : base(extent)
        {
            ...
            {
                throw PSTraceSource.NewArgumentNullException(attribute is null ? "attribute" : "child");
            }
        ...
        private ISupportsAssignment GetActualAssignableAst()
        {
            ...
            while (childAttributeAst is not null)
            {
    ...
    public class ConvertExpressionAst : AttributedExpressionAst, ISupportsAssignment
    {
        ...
        IAssignableValue ISupportsAssignment.GetAssignableValue()
        {
            ...
            if (varExpr is not null && varExpr.TupleIndex >= 0)
            {
    ...
    public class MemberExpressionAst : ExpressionAst, ISupportsAssignment
    {
        ...
        public MemberExpressionAst(IScriptExtent extent, ExpressionAst expression, CommandElementAst member, bool @static)
            : base(extent)
        {
            if (expression is null || member is null)
            {
                throw PSTraceSource.NewArgumentNullException(expression is null ? "expression" : "member");
            }
    ...
    public class InvokeMemberExpressionAst : MemberExpressionAst, ISupportsAssignment
    {
        ...
        internal AstVisitAction InternalVisitChildren(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.Continue)
                action = Member.InternalVisit(visitor);
            if (action == AstVisitAction.Continue && Arguments is not null)
            {
    ...
    public sealed class TypeName : ITypeName, ISupportsTypeCaching
    {
        ...
        {
            if (extent is null || string.IsNullOrEmpty(name))
            {
                throw PSTraceSource.NewArgumentNullException(extent is null ? "extent" : "name");
            }
        ...
        /// </summary>
        public string FullName { get { return AssemblyName is not null ? _name + "," + AssemblyName : _name; } }
        ...
        public Type GetReflectionType()
        {
            ...
            {
                Exception e;
                Type type = _typeDefinitionAst is not null ? _typeDefinitionAst.Type : TypeResolver.ResolveTypeName(this, out e);
                if (type is not null)
                {
                    try
                    {
                    ...
                    catch (NotSupportedException)
                    {
                        ...
                        Diagnostics.Assert(_typeDefinitionAst is not null, "_typeDefinitionAst can never be null");
                        return type;
                    }
        ...
        public Type GetReflectionAttributeType()
        {
            ...
            if (result is null || !typeof(Attribute).IsAssignableFrom(result))
            {
                var attrTypeName = new TypeName(_extent, FullName + "Attribute");
                result = attrTypeName.GetReflectionType();
                if (result is not null && !typeof(Attribute).IsAssignableFrom(result))
                {
                    result = null;
                }
            }
        ...
        {
            Diagnostics.Assert(_typeDefinitionAst is null, "Class definition is already set and cannot be changed");
            Diagnostics.Assert(_type is null, "Cannot set class definition if type is already resolved");
        ...
        public override bool Equals(object obj)
        {
            ...
            if (AssemblyName is null)
                return other.AssemblyName is null;

            if (other.AssemblyName is null)
                return false;
    ...
    public sealed class GenericTypeName : ITypeName, ISupportsTypeCaching
    {
        ...
        {
            if (genericTypeName is null || extent is null)
            {
                throw PSTraceSource.NewArgumentNullException(extent is null ? "extent" : "genericTypeName");
            }
        ...
        {
            if (generic is null || !generic.ContainsGenericParameters)
            {
    ...
    public sealed class ArrayTypeName : ITypeName, ISupportsTypeCaching
    {
        ...
        {
            if (extent is null || elementType is null)
            {
                throw PSTraceSource.NewArgumentNullException(extent is null ? "extent" : "name");
            }
    ...
    public class VariableExpressionAst : ExpressionAst, ISupportsAssignment, IAssignableValue
    {
        ...
        internal bool IsSafeVariableReference(HashSet<string> validVariables, ref bool usesParameter)
        {
            ...
            if (this.VariablePath.IsAnyLocal())
            {
                ...
                if (((validVariables is not null) && validVariables.Contains(varName)) ||
    ...
    public class ConstantExpressionAst : ExpressionAst
    {
        ...
        public override Type StaticType
        {
            get { return Value is not null ? Value.GetType() : typeof(object); }
        }
    ...
    public class ExpandableStringExpressionAst : ExpressionAst
    {
            ...
            : base(extent)
        {
            ...
            if (expandableStringAst is not null)
            {
        ...
        private ExpandableStringExpressionAst(IScriptExtent extent, string value, string formatString,
            ...
            : base(extent)
        {
            Diagnostics.Assert(nestedExpressions is not null && nestedExpressions.Any(), "Must specify non-empty expressions.");
        ...
        internal override AstVisitAction InternalVisit(AstVisitor visitor)
        {
            ...
            if (action == AstVisitAction.SkipChildren)
                return visitor.CheckForPostAction(this, AstVisitAction.Continue);
            if (action == AstVisitAction.Continue && NestedExpressions is not null)
            {
    ...
    public class IndexExpressionAst : ExpressionAst, ISupportsAssignment
    {
        ...
        public IndexExpressionAst(IScriptExtent extent, ExpressionAst target, ExpressionAst index)
            : base(extent)
        {
            if (target is null || index is null)
            {
                throw PSTraceSource.NewArgumentNullException(target is null ? "target" : "index");
            }
