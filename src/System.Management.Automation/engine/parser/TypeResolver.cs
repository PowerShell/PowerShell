        ...
        internal static Lazy<Dictionary<Type, string[]>> Items = new Lazy<Dictionary<Type, string[]>>(
            () =>
                new Dictionary<Type, string[]>
                {
                    ...
                    { typeof(ValidatePositiveAttribute),                   new[] { "ValidatePositive" } },
                    { typeof(ValidateNegativeAttribute),                   new[] { "ValidateNegative" } },
                    { typeof(ValidateNonPositiveAttribute),                new[] { "ValidateNonPositive" } },
                    { typeof(ValidateNonNegativeAttribute),                new[] { "ValidateNonNegative" } },
