    ...
    internal sealed class LabelInfo
    {
        ...
        internal void Define(LabelScopeInfo block)
        {
            ...
            for (LabelScopeInfo j = block; j != null; j = j.Parent)
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, $"Label target already defined: {_node.Name}"));
                }
            }
        ...
        private void ValidateJump(LabelScopeInfo reference)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, $"Ambiguous jump {_node.Name}"));
            }
