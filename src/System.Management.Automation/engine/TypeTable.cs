...
namespace System.Management.Automation.Runspaces
{
    ...
    internal class TypesPs1xmlReader
    {
        ...
        private TypeData Read_Type()
        {
            ...
            else if (members is null && typeConverter is null && typeAdapter is null)
            {
                            ...
                            else
                            {
                                ...
                                while (_reader.NodeType != XmlNodeType.EndElement && _reader.NodeType != XmlNodeType.None)
                                {
                                    if (_reader.NodeType == XmlNodeType.Element)
                                    {
                                        if ((object)_reader.LocalName == (object)_idName)
                                        {
                                            if (referencedProperties is null)
                                            {
        ...
        private CodeMethodData Read_CodeMethod()
        {
            ...
            if (codeReference is null && methodLineNumber == 0)
                NodeNotFound(lineNumber, _idCodeReference, _idCodeMethod);
            if (codeReference is not null && !PSCodeMethod.CheckMethodInfo(codeReference))
                _context.AddError(methodLineNumber, ExtendedTypeSystem.CodeMethodMethodFormat);
        ...
        private CodePropertyData Read_CodeProperty()
        {
            ...
            if (getter is null && setter is null && getterLineNumber == 0 && setterLineNumber == 0)
            {
                _context.AddError(lineNumber, TypesXmlStrings.CodePropertyShouldHaveGetterOrSetter);
            }

            if (getter is not null && !PSCodeProperty.CheckGetterMethodInfo(getter))
            {
                _context.AddError(getterLineNumber, ExtendedTypeSystem.CodePropertyGetterFormat);
            }

            if (setter is not null && !PSCodeProperty.CheckSetterMethodInfo(setter, getter))
            {
        ...
        private AliasPropertyData Read_AliasProperty()
        {
            ...
            else
            {
                ...
                while (_reader.NodeType != XmlNodeType.EndElement && _reader.NodeType != XmlNodeType.None)
                {
                    if (_reader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            if (referencedMemberName is not null)
                            {
            ...
            Type convertToType = (typeName is not null) ? ResolveType(typeName, typeLineNumber) : null;
    ...
    public sealed class TypeData
    {
        ...
        public string SerializationMethod
        {
            ...
            set
            {
                ...
                if (_serializationMethod is null)
                {
        ...
        public Type TargetTypeForDeserialization
        {
            ...
            set
            {
                ...
                if (_targetTypeForDeserialization is null)
                {
        ...
        public string DefaultDisplayProperty
        {
            ...
            set
            {
                ...
                if (_defaultDisplayProperty is null)
                {
        ...
        public string StringSerializationSource
        {
            ...
            set
            {
                ...
                if (_stringSerializationSourceProperty is not null)
                {
        ...
        public TypeData Copy()
        {
            ...
            newTypeData.DefaultDisplayPropertySet = this.DefaultDisplayPropertySet is null
                                                        ? null
                                                        : (PropertySetData)this.DefaultDisplayPropertySet.Copy();
            newTypeData.DefaultKeyPropertySet = this.DefaultKeyPropertySet is null
                                                    ? null
                                                    : (PropertySetData)this.DefaultKeyPropertySet.Copy();
            newTypeData.PropertySerializationSet = this.PropertySerializationSet is null
                                                       ? null
    ...
    public sealed partial class TypeTable
    {
        ...
        private static void AddMember(ConcurrentBag<string> errors, string typeName, PSMemberInfo member, PSMemberInfoInternalCollection<PSMemberInfo> membersCollection, bool isOverride)
        {
            ...
            if (membersCollection[member.name] is not null && !isOverride)
            {
            ...
            if (membersCollection[member.name] is null)
            {
        ...
        private static bool GetCheckNote(ConcurrentBag<string> errors, string typeName, PSMemberInfoInternalCollection<PSMemberInfo> members, string noteName, Type noteType, out PSNoteProperty note)
        {
            ...
            if (noteType.GetTypeCode().Equals(TypeCode.Boolean))
            {
                ...
                if (sourceValueAsString is not null)
                {
        ...
        private static bool CheckStandardMembers(ConcurrentBag<string> errors, string typeName, PSMemberInfoInternalCollection<PSMemberInfo> members)
        {
            ...
            do // false loop
            {
                ...
                if (serializationMethodNote is not null)
                {
                ...
                else if (serializationMethod == SerializationMethod.SpecificProperties)
                {
                    ...
                    if (inheritPropertiesNote is not null && inheritPropertiesNote.Value.Equals(false) && propertySerializationSet is null)
                    {
                        AddError(
                            errors,
                            typeName,
            ...
            {
                if (targetTypeForDeserialization is not null)
                {
...
#pragma warning restore 56500
        ...
        {
            if ((codePropertyData.GetCodeReference is null) && (codePropertyData.SetCodeReference is null))
            {
        ...
        {
            if (scriptMethodData.Script is null)
            {
        ...
        {
            if (codeMethodData.CodeReference is null)
            {
        ...
        {
            if (propertySetData.ReferencedProperties is null || propertySetData.ReferencedProperties.Count == 0)
            {
            ...
            bool isOverride)
        {
            ...
            if (membersCollection[PSStandardMembers] is null)
            {
            ...
            else
            {
                ...
                {
                    if (oldMembersCopy[member.name] is null)
                    {
        ...
        {
            // If StandardMembers do not exists, we follow the original logic to create the StandardMembers
            if (typeMemberCollection[PSStandardMembers] is null)
            {
                CheckStandardMembers(errors, typeName, memberSetMembers);
                PSMemberSet standardMemberSet = new PSMemberSet(PSStandardMembers, memberSetMembers)
                {
            ...
            bool isOverride)
        {
            ...
            if (instance is not null && !typeConverters.TryAdd(typeName, instance))
            {
                if (!isOverride)
                {
            ...
            bool isOverride)
        {
            ...
            if (adapterSet is not null && !typeAdapters.TryAdd(typeName, adapterSet))
            {
                if (!isOverride)
                {
        ...
        private void ProcessTypeDataToAdd(ConcurrentBag<string> errors, TypeData typeData)
        {
            ...
            if (typeData.DefaultDisplayPropertySet is not null)
            {
                propertySets.Add(typeData.DefaultDisplayPropertySet);
            }

            if (typeData.DefaultKeyPropertySet is not null)
            {
                propertySets.Add(typeData.DefaultKeyPropertySet);
            }

            if (typeData.PropertySerializationSet is not null)
            {
        ...
        {
            if (types is null || string.IsNullOrEmpty(types.Key))
            {
        ...
        private PSMemberInfoInternalCollection<PSMemberInfo> MemberFactory(string k, ConsolidatedString types)
        {
            ...
            for (int i = types.Count - 1; i >= 0; i--)
            {
                ...
                foreach (PSMemberInfo typeMember in typeMembers)
                {
                    ...
                    if (currentMemberAsMemberSet is null || typeMemberAsMemberSet is null ||
                    ...
                    {
                        if (currentMemberAsMemberSet.Members[typeMemberAsMemberSetMember.Name] is null)
                        {
        ...
        {
            Dbg.Assert(member is not null, "caller should guarantee that member is not null");
            Dbg.Assert(typeData is not null, "caller should guarantee that typeData is not null");
        ...
        {
            Dbg.Assert(typeData is not null && typeData.TypeName is not null, "The caller needs to make sure typeData is not null");
            string typeName = typeData.TypeName;

            PSMemberInfoInternalCollection<PSMemberInfo> typeMembers;
            if (_extendedMembers.TryGetValue(typeName, out typeMembers))
            {
                Dbg.Assert(typeMembers is not null, "members should not be null");
        ...
        private bool RetrieveConverterToTypeData(TypeData typeData)
        {
            ...
            {
                Dbg.Assert(converterResult is not null, "converter should not be null");
        ...
        private bool RetrieveAdapterToTypeData(TypeData typeData)
        {
            ...
            {
                Dbg.Assert(adapterResult is not null, "adapter should not be null");
