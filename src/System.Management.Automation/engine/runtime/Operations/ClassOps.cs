...
namespace System.Management.Automation.Internal
{
    ...
    public class SessionStateKeeper
    {
        ...
        internal void RegisterRunspace()
        {
            ...
            // If the key exists but the corresponding value is not what we should use, then update the key/value pair.
            // This could happen when a powershell class is defined in a module and the module gets reloaded.
            // In such case, the same TypeDefinitionAst instance will get reused,
            // but should be associated with the SessionState from the new module, instead of the one from the old module.
