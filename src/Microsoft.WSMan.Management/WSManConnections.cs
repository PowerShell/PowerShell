...
namespace Microsoft.WSMan.Management
{
    ...
    public class ConnectWSManCommand : AuthenticatingWSManCommand
    {
        ...
        protected override void BeginProcessing()
        {
            ...
            helper.CreateWsManConnection(ParameterSetName, connectionuri, port, computername, applicationname, usessl.IsSpecified, Authentication, sessionoption, Credential, CertificateThumbprint);
        }
    }
    #endregion
