...
Note that PSCredential is not yet supported.
...
2. PSCredential is not yet supported.
3. Remote debugging from Linux to Windows does not work.  However, remote debugging from Windows to Linux does work.
4. Fan out to multiple machines not yet supported.
5. sudo command does not work in remote session to Linux machine.
