#
# Module manifest for module 'AzureRM.Resources.NetCore.Preview'
#
...
RequiredModules = @(@{ModuleName = 'AzureRM.Profile.NetCore.Preview'; RequiredVersion = '0.3.0'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ResourceManager','ARM','ActiveDirectory','Authorization'
