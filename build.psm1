...
function Switch-PSNugetConfig {
    ...
    if ( $Source -eq 'Public') {
        ...
        $powerShellPackages = [NugetPackageSource] @{Url = 'https://pkgs.dev.azure.com/powershell/PowerShell/_packaging/powershell-preview-7-5-test/nuget/v3/index.json'; Name = 'powershell' }
