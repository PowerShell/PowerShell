...
function Start-PSPackage {
    ...
    End {
        ...
        $precheckFailed = if ($Type -eq 'fxdependent') {
            ...
            $Script:Options.Framework -ne "netcoreapp2.2"           ## Last build wasn't for CoreCLR
        } else {
            -not $Script:Options -or                                ## Start-PSBuild hasn't been executed yet
