...
if ($dotnetUpdate.ShouldUpdate) {
    ...
    if ($UpdateMSIPackaging) {
        ...
        Start-PSBuild -Clean -Configuration Release -CrossGen -InteractiveAuth:$InteractiveAuth -ExperimentalFeatureJsonFilePath "$PSScriptRoot/../ExperimentalFeatures.json"
